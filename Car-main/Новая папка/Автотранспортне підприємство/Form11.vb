Public Class Працівники_табл
    Private Sub Працівники_табл_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ПрацівникиBindingSource.Filter = "Name='" & ComboBox1.Text & "'"
    End Sub
