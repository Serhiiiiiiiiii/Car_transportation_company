Public Class Посади_табл
    Private Sub Посади_табл_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ПосадиBindingSource.Filter = "Job_title='" & ComboBox1.Text & "'"
    End Sub
